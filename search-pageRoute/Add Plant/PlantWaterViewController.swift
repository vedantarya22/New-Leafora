...
//     continue to next screen
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toNextScreen" {
            if let nextVC = segue.destination as? PlantRepotViewController { // Change to your actual next VC class
    ...
    func registerCell() {
        ...
        optionsCollectionView.register(nib, forCellWithReuseIdentifier: "OptionButtonCell")
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: "OptionButtonCell",
                for: indexPath
